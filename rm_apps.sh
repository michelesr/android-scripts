...
cd /system/app
mv -fv messaging Profiles LatinIME BasicDreams LockClock Calendar Email PhotoTable PicoTts Jelly NfcNci HTMLViewer EasterEgg FaceLock GoogleContactsSyncAdapter GoogleCalendarSyncAdapter $BACKUP_DIR/app/

cd /system/priv-app
mv -fv Velvet MmsService LineageSetupWizard SetupWizard AudioFX Tag Turbo Eleven Snap CalendarProvider CallLogBackup WeatherProvider Trebuchet GoogleBackupTransport GoogleOneTimeInitializer GooglePartnerSetup GoogleFeedback EmergencyInfo $BACKUP_DIR/priv-app/
